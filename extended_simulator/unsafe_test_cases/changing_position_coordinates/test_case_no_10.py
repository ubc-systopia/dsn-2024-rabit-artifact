...
if __name__ == '__main__':
    ...
    ## Scenario: robot arm colliding with the grid in its trajectory when moving from the dosing device to the thermoshaker
    ## (refer to locations['thermoshaker']['arm']['pickup_safe_height])
