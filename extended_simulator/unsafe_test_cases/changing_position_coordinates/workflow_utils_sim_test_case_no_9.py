...
locations = {
    ...
    "thermoshaker": {
        "arm": {
            ## Scenario: robot arm height to place the vial inside the thermoshaker is increased to a high max value.
            #"pickup_safe_height": [427.2, -234.2, 244.1, 178.6, 1.437, -88.08],
            "pickup_safe_height": [427.2, -234.2, 10000, 178.6, 1.437, -88.08],
