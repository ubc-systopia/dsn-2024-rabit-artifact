...
if __name__ == '__main__':
    ...
    ## Scenario: robot arm moves outside the dosing device from a location other than the door; refer to workflow_utils.py
    ## (arm_place_object method) where we changed the location when robot arm moves outside the dosing device
