...
def arm_place_object(arm, pose, obj):
    ...
    ## Scenario: robot arm tries to move outside the dosing device other than its door (from top of the dosing device)
    random_location = [140.8, 458.5, 300, 178.6, 1.437, -88.08]
    #arm_move(arm, pose["pickup_safe_height"], 0)
    arm_move(arm, random_location, 0)
