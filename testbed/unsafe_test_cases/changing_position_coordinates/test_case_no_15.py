...
if __name__ == '__main__':
    ...
    ## Scenario: ViperX height to place the vial inside the thermoshaker is increased to a high max value.
    ## (refer to locations["thermoshaker"]["viperx"]["pickup_safe_height"])
