...
if __name__ == '__main__':
    ...
    ## Scenario: viperx when holding the vial was placed inside the dosing device, the height of the robot
    ## arm’s location is reduced to be above the platform but with the vial extending beyond it
    ## (refer to locations["dosing_device"]["viperx"]["pickup"] in workflow_utils_test_case_no_13.py)
