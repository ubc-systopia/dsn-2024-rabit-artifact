...
if __name__ == '__main__':
    ...
    ## Scenario: viperx moving into the dosing device from a location (variable: random_location) other than its door (top of dosing device).
    ## Added a random location
    random_location = {            
        "approach": [0.15, 0.347, 0.35],           
        "pickup_safe_height": [0.15, 0.475, 0.35],
        "pickup": [0.15, 0.45, 0.10]
        }
    viperx_place_object(viperx, random_location, vial)
