...
if __name__ == '__main__':
    ...
    ## Scenario: viperx moves outside the dosing device from a location other than the door; refer to workflow_utils_test_case_no_5.py
    ## (viperx_place_object method) where we changed the location when viperx moves outside the dosing device
